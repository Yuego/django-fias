...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NormDoc.doctype'
        db.alter_column(u'fias_normdoc', 'doctype', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'NormDoc.docimgid'
        db.alter_column(u'fias_normdoc', 'docimgid', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'NormDoc.doctype'
        db.alter_column(u'fias_normdoc', 'doctype', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'NormDoc.docimgid'
        db.alter_column(u'fias_normdoc', 'docimgid', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'fias.normdoc': {
            ...
            'docimgid': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'doctype': ('django.db.models.fields.PositiveIntegerField', [], {}),
