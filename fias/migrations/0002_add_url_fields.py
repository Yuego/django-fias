...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocrBase.scname_ru'
        db.add_column(u'fias_socrbase', 'scname_ru',
                      self.gf('django.db.models.fields.CharField')(default=u' ', max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SocrBase.scname_uk'
        db.add_column(u'fias_socrbase', 'scname_uk',
                      self.gf('django.db.models.fields.CharField')(default=u' ', max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SocrBase.scname_en'
        db.add_column(u'fias_socrbase', 'scname_en',
                      self.gf('django.db.models.fields.CharField')(default=u' ', max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SocrBase.socrname_ru'
        db.add_column(u'fias_socrbase', 'socrname_ru',
                      self.gf('django.db.models.fields.CharField')(default=u' ', max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SocrBase.socrname_uk'
        db.add_column(u'fias_socrbase', 'socrname_uk',
                      self.gf('django.db.models.fields.CharField')(default=u' ', max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SocrBase.socrname_en'
        db.add_column(u'fias_socrbase', 'socrname_en',
                      self.gf('django.db.models.fields.CharField')(default=u' ', max_length=50, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'AddrObj.formalname_ru'
        db.add_column(u'fias_addrobj', 'formalname_ru',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=120, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AddrObj.formalname_uk'
        db.add_column(u'fias_addrobj', 'formalname_uk',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=120, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AddrObj.formalname_en'
        db.add_column(u'fias_addrobj', 'formalname_en',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=120, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AddrObj.shortname_ru'
        db.add_column(u'fias_addrobj', 'shortname_ru',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AddrObj.shortname_uk'
        db.add_column(u'fias_addrobj', 'shortname_uk',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AddrObj.shortname_en'
        db.add_column(u'fias_addrobj', 'shortname_en',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocrBase.scname_ru'
        db.delete_column(u'fias_socrbase', 'scname_ru')

        # Deleting field 'SocrBase.scname_uk'
        db.delete_column(u'fias_socrbase', 'scname_uk')

        # Deleting field 'SocrBase.scname_en'
        db.delete_column(u'fias_socrbase', 'scname_en')

        # Deleting field 'SocrBase.socrname_ru'
        db.delete_column(u'fias_socrbase', 'socrname_ru')

        # Deleting field 'SocrBase.socrname_uk'
        db.delete_column(u'fias_socrbase', 'socrname_uk')

        # Deleting field 'SocrBase.socrname_en'
        db.delete_column(u'fias_socrbase', 'socrname_en')
        ...
        # Deleting field 'AddrObj.formalname_ru'
        db.delete_column(u'fias_addrobj', 'formalname_ru')

        # Deleting field 'AddrObj.formalname_uk'
        db.delete_column(u'fias_addrobj', 'formalname_uk')

        # Deleting field 'AddrObj.formalname_en'
        db.delete_column(u'fias_addrobj', 'formalname_en')

        # Deleting field 'AddrObj.shortname_ru'
        db.delete_column(u'fias_addrobj', 'shortname_ru')

        # Deleting field 'AddrObj.shortname_uk'
        db.delete_column(u'fias_addrobj', 'shortname_uk')

        # Deleting field 'AddrObj.shortname_en'
        db.delete_column(u'fias_addrobj', 'shortname_en')
