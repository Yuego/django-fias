...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocrBase.item_weight'
        db.add_column(u'fias_socrbase', 'item_weight',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=64),
                      keep_default=False)

        # Adding field 'AddrObjIndex.item_weight'
        db.add_column(u'fias_addrobjindex', 'item_weight',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SocrBase.item_weight'
        db.delete_column(u'fias_socrbase', 'item_weight')

        # Deleting field 'AddrObjIndex.item_weight'
        db.delete_column(u'fias_addrobjindex', 'item_weight')
